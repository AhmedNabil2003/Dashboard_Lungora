...
>
  ...
  <ul className="space-y-4">
    {filteredArticles.length === 0 ? (
      <p className={`text-center ${theme === "light" ? "text-gray-500" : "text-gray-300"}`}>
        No articles found
      </p>
    ) : (
  ...
  <div className="w-full text-center mt-4">
    <button
      ...
      className={`${
        theme === "light" ? "text-sky-600 hover:underline" : "text-sky-400 hover:underline"
  ...
  >
    <motion.div
      className={`${
        theme === "light" ? "bg-white" : "bg-gray-800"
      } p-6 rounded-lg shadow-lg w-full max-w-md mx-4`}
      initial={{ scale: 0.8 }}
      animate={{ scale: 1 }}
      transition={{ duration: 0.3 }}
    >
      <h3
        ...
        } text-xl font-bold mb-4 capitalize border-b pb-2`}
      >
  ...
  >
    ...
    >
      ...
      >
        Are you sure you want to delete the Article "{currentDeleteItem?.title}"? This action cannot be undone.
      </p>
      <div className="flex justify-end space-x-2">
        ...
        <button
          ...
          className="bg-red-600 text-white px-4 py-2 rounded-md transition duration-200"
        >
          Delete
        </button>
      </div>
    ...
    >
      ...
      <div className="flex justify-end space-x-2 mt-4">
        <button
          ...
          } text-white cursor-pointer px-4 py-2 rounded-md transition duration-200`}
        >
          Close
        </button>
      </div>
